            ...
            <div className="space-y-4">
              ...
              <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                ...
                <div className="grid grid-cols-2 gap-4 text-sm">
                  <div><strong>Type:</strong> {watchedValues.questionBankType || 'Not selected'}</div>
                  <div><strong>Chapter:</strong> {watchedValues.chapter || 'Not selected'}</div>
                  <div><strong>Topic:</strong> {watchedValues.topic || 'Not selected'}</div>
                  <div><strong>Category:</strong> {watchedValues.category || 'Not selected'}</div>
                  <div><strong>Difficulty:</strong> {watchedValues.difficulty || 'Medium'}</div>
                  <div><strong>Marks:</strong> {watchedValues.marks || 1}</div>
                </div>
              </div>
            </div>
          </DialogContent>
