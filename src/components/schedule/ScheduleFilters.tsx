...
import { ScheduleFilters as ScheduleFiltersType } from '@/types/schedule';
import { getUniqueSubjects, getUniqueFaculties, getUniqueClasses } from '@/data/mockSchedule';
...
export function ScheduleFilters({ filters, onFiltersChange, onClearAll }: ScheduleFiltersProps) {
