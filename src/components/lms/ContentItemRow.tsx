...
export const ContentItemRow: React.FC<ContentItemRowProps> = ({
  ...
  return (
    <div className="w-full bg-white/80 rounded-md border hover:bg-white hover:shadow-sm transition-all group overflow-hidden">
      {/* Mobile Layout */}
      <div className="flex flex-col gap-3 p-3 md:hidden">
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1 min-w-0">
            <h5 className="font-medium text-sm group-hover:text-blue-600 transition-colors break-words">
              {item.title}
            </h5>
          </div>
